...
export default function PoliticaPrivacidadClient({ dict }: any) {
    return (
        <main style={{
            minHeight: '100vh',
            ...
            {/* Hero Section */}
            <SubpageHero
                title={dict.politicaPrivacidad.hero.title}
                subtitle={dict.politicaPrivacidad.hero.subtitle}
            />
            ...
            <section style={{
                ...
                >
                    <p style={{
                        ...
                        {dict.politicaPrivacidad.introduction}
                    </p>
                </motion.div>

                {/* Sections */}
                {dict.politicaPrivacidad.sections.map((section: any, index: number) => (
                    <motion.div
                        key={index}
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}
                ...
                >
                    <p style={{
                        ...
                        {dict.politicaPrivacidad.footer}
                    </p>
                </motion.div>
            </section>
