          ...
          >
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
              <motion.div
                ...
                className="absolute -top-20 -right-20 w-40 h-40 bg-amber-400/30 rounded-full blur-3xl"
              />
              <motion.div
                animate={{ opacity: [0.1, 0.15, 0.1], scale: [1, 1.05, 1] }}
                transition={{ duration: 6, repeat: Infinity, delay: 0.5 }}
                className="absolute -bottom-20 -left-20 w-40 h-40 bg-cyan-400/30 rounded-full blur-3xl"
              />
            </div>
