    ...
    <section id="contacto" className="py-24 px-6 bg-white dark:bg-slate-900">
      <div className="max-w-3xl mx-auto">
        ...
        <motion.div
          ...
          className="bg-gradient-to-br from-blue-50/50 to-blue-100/30 dark:from-slate-800 dark:to-blue-950/30 rounded-3xl p-8 md:p-10 shadow-lg border border-blue-100 dark:border-slate-700"
        >
          <ContactForm />
        </motion.div>
      </div>
