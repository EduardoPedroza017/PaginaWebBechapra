...
export default function HowWeWork({
  ...
  return (
    <section className="relative w-screen -ml-[calc(50vw-50%)] py-24 px-6 bg-gradient-to-br from-blue-50 via-cyan-50/50 to-slate-50 overflow-hidden">
      {/* Decorative */}
      <div className="absolute -top-20 -left-20 w-72 h-72 bg-gradient-to-br from-cyan-200/30 to-blue-200/20 rounded-full blur-3xl" />
      <div className="absolute -bottom-16 -right-16 w-56 h-56 bg-gradient-to-tl from-teal-200/25 to-emerald-200/15 rounded-full blur-3xl" />
