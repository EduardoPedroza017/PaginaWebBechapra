...
export default function TrainingCTA({
  ...
  return (
    <section className="relative w-full py-24 px-6 bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 dark:from-slate-950 dark:via-blue-950 dark:to-slate-900 overflow-hidden">
      {/* Animated Background */}
