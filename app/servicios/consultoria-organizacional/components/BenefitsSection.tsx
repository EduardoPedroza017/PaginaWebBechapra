        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {benefits.map((benefit, i) => {
            ...
            return (
              ...
              >
                <div className="w-16 h-16 mx-auto mb-5 bg-gradient-to-br from-blue-100 to-indigo-100 dark:from-slate-900/50 dark:to-slate-900/50 rounded-2xl flex items-center justify-center group-hover:from-blue-500 group-hover:to-indigo-600 dark:group-hover:from-slate-600 dark:group-hover:to-slate-700 transition-all duration-300">
                  <Icon
                    size={32}
