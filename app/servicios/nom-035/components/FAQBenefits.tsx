...
export default function FAQBenefits({ faqs, benefits }: FAQBenefitsProps) {
  ...
  return (
    <section className="relative w-full py-24 px-6 bg-gradient-to-br from-blue-50 via-indigo-50/50 to-blue-50/30 dark:from-slate-950 dark:via-blue-950/30 dark:to-slate-900">
