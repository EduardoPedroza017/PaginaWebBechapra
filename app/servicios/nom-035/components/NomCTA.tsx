...
export default function NomCTA({
  ...
  return (
    <section className="relative w-screen -ml-[calc(50vw-50%)] py-24 px-6 bg-gradient-to-br from-emerald-600 via-teal-600 to-cyan-700 overflow-hidden">
      {/* Animated Background */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <motion.div
          ...
          className="absolute -bottom-1/2 -left-1/4 w-3/4 h-full bg-gradient-to-tr from-teal-400/20 to-transparent rounded-full"
        />
        {/* Floating Icons */}
        {[...Array(6)].map((_, i) => (
          <motion.div
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        >
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
            <Link
              href={primaryLink}
              className="inline-flex items-center gap-3 px-10 py-5 bg-white text-emerald-700 rounded-2xl font-bold text-lg shadow-xl shadow-black/15 hover:shadow-2xl hover:bg-emerald-50 transition-all duration-300"
            >
              {primaryLabel}
              <ArrowRight size={22} />
            </Link>
