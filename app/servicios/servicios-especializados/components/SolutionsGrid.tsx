              ...
              >
                ...
                <div
                  className={`relative z-10 w-[70px] h-[70px] rounded-2xl flex items-center justify-center mb-6 transition-all duration-400 ${
                    isHovered
                      ? "bg-blue-600 dark:bg-blue-500 rotate-[-5deg] scale-110"
                ...
                <div
                  className={`relative z-10 mt-6 flex items-center gap-2 font-bold text-sm transition-all duration-300 ${
                    isHovered
                      ? "text-blue-700 dark:text-blue-400 opacity-100 translate-x-0"
                      : "text-blue-600 dark:text-blue-500 opacity-0 -translate-x-3"
                  }`}
                >
                  <TranslateText text="Conocer mas" /> <ChevronRight size={18} />
                </div>
              </motion.div>
            );
          })}
