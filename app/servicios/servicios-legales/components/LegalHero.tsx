...
export default function LegalHero() {
  return (
    <section className="relative w-screen -ml-[calc(50vw-50%)] min-h-[620px] bg-gradient-to-br from-slate-950 via-slate-900 to-violet-950 pt-20 pb-32 overflow-hidden">
      {/* Animated Background */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <motion.div
          animate={{ scale: [1, 1.2, 1], rotate: [0, 90, 0] }}
          transition={{ duration: 20, repeat: Infinity, ease: "linear" }}
          className="absolute -top-1/3 -right-1/4 w-[700px] h-[700px] bg-gradient-to-br from-violet-400/20 via-purple-500/15 to-transparent rounded-full blur-3xl"
        />
        <motion.div
          animate={{ scale: [1, 1.3, 1], rotate: [0, -90, 0] }}
          transition={{ duration: 25, repeat: Infinity, ease: "linear" }}
          className="absolute -bottom-1/4 -left-1/4 w-[500px] h-[500px] bg-gradient-to-tr from-amber-400/10 via-violet-500/10 to-transparent rounded-full blur-3xl"
        />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-semibold text-violet-200">Protección Legal</span>
            </motion.div>
            ...
            <p className="text-lg md:text-xl text-violet-100/90 leading-relaxed mb-8 max-w-xl">
            ...
            <div className="flex gap-8 mb-10">
              {[
                ...
                >
                  <div className="text-3xl font-black bg-gradient-to-r from-amber-400 to-yellow-400 bg-clip-text text-transparent">
                    {stat.value}
                  </div>
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Link
                href="#contacto"
                className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-violet-500 to-purple-600 text-white rounded-2xl font-bold text-lg shadow-xl shadow-violet-500/25 hover:shadow-violet-500/40 transition-all duration-300"
              >
                Solicitar asesoría
          ...
          >
            ...
            <div className="relative h-[420px] bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm rounded-3xl border border-white/20 p-8 flex flex-col justify-center">
              {/* Top accent */}
              <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-violet-400 via-purple-500 to-amber-400 rounded-t-3xl" />
              
              {/* Central Icon */}
              <motion.div
                animate={{ scale: [1, 1.05, 1], rotate: [0, 5, -5, 0] }}
                transition={{ duration: 4, repeat: Infinity }}
                className="w-32 h-32 mx-auto mb-6 bg-gradient-to-br from-violet-500 to-purple-600 rounded-3xl flex items-center justify-center shadow-2xl shadow-violet-500/30"
              >
                <Scale className="w-16 h-16 text-white" />
              </motion.div>

              <h3 className="text-2xl font-bold text-white text-center mb-3">Protección Total</h3>
              <p className="text-violet-200/80 text-center text-lg mb-6">Tu empresa segura y en cumplimiento</p>
