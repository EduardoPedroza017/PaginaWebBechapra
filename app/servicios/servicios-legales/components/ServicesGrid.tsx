    ...
    <section className="py-24 px-6 bg-white dark:bg-slate-900">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          >
            <TranslateText text="Áreas de Práctica" />
          </motion.span>
              ...
              >
                ...
                <div className="flex gap-6">
                  ...
                  <motion.div
                    ...
                    className="w-16 h-16 bg-gradient-to-br from-blue-500 to-indigo-600 dark:from-blue-600 dark:to-indigo-700 rounded-2xl flex items-center justify-center flex-shrink-0 shadow-lg shadow-blue-500/20 dark:shadow-blue-900/20 group-hover:shadow-blue-500/40 dark:group-hover:shadow-blue-900/40 transition-shadow duration-300"
                  >
