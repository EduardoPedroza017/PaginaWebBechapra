...
export default function PymeCTA() {
  ...
  return (
    <section className="relative w-full py-24 px-6 bg-gradient-to-br from-blue-500 via-blue-600 to-indigo-600 dark:from-slate-950 dark:via-slate-950 dark:to-slate-900 overflow-hidden">
      {/* Animated Background */}
