...
export default function UseCasesSection({ useCases }: UseCasesSectionProps) {
  return (
    <section className="relative w-full py-24 px-6 bg-gradient-to-br from-blue-50 via-blue-50/50 to-blue-50/30 dark:from-slate-950 dark:via-slate-950/30 dark:to-slate-900 overflow-hidden">
      {/* Decorative */}
